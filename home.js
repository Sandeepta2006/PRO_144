...
export default class HomeScreen extends Component {
  ...
  getArticle = () => {
    const url = "https://50869ca69e89.ngrok.io/get-article";
    axios
      .get(url)
      .then(response => {
  ...
  likedArticle = () => {
    const url = "https://50869ca69e89.ngrok.io/liked-article";
    axios
      .post(url)
      .then(response => {
        this.getArticle();
  ...
  unlikedArticle = () => {
    const url = "https://50869ca69e89.ngrok.io/unliked-article";
    axios
      .post(url)
      .then(response => {
        this.getArticle();
